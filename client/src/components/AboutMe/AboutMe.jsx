...
function AboutMe() {
  return (
    <div className="aboutme section" id="aboutme">
        ...
        <img src={Flowers} alt="Flowers" className="aboutme__flowers"/>
        ...
        <div className="aboutme__section">
            ...
            <br/><br/>Presently, my go-to games are <a href="https://chawpsticks.herokuapp.com"><span className="valorant red">Valorant</span></a> and Lost Ark. I have been playing Valorant (hardstuck plat) since beta and I play Lost Ark when work is slow (current iLvl is 1370). Before that, I wasted a lot of time playing League of Legends (played for 8 seasons, highest rank achieved was plat 1). Other than gaming, I do enjoy spending time hanging out with loved ones and travelling.</p>
        </div>
    </div>
  )
}
