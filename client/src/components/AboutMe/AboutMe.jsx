    ...
    <div className="section" id="aboutme">
      ...
      <div className="aboutme">     
          ...
          <div className="aboutme__section">
              ...
              <br/><br/><br/>Presently, my go-to games are <a href="https://tracker.gg/valorant/profile/riot/Chawpsticks%23123/overview" target="_blank" rel="noreferrer"><span className="valorant">Valorant</span></a> and <span className="bold">Lost Ark</span>. <br/><br/>I have been playing Valorant since beta (currently Plat 3) and I play Lost Ark during down times (iLvl = 1400). Before that, I wasted a lot of time playing <a href="https://na.op.gg/summoners/na/Chawpsticks" target="_blank" rel="noreferrer"><span className="league bold">League of Legends</span></a>. <br/><br/><i>Other than gaming</i>, I do enjoy spending time hanging out with loved ones and travelling.</p>
              <div className="blob">
