    ...
    <div className="section" id="aboutme">
      ...
      <div className="aboutme">     
          ...
          <div className="aboutme__section">
              ...
              <br/><br/>Presently, my go-to games are <a href="https://tracker.gg/valorant/profile/riot/Chawpsticks%23123/overview" target="_blank" rel="noreferrer"><span className="valorant">Valorant</span></a> and <span className="bold">Lost Ark</span>. <br/><br/>I have been playing Valorant (hardstuck plat) since beta and I play Lost Ark during down times (iLvl = 1385). Before that, I wasted a lot of time playing <a href="https://na.op.gg/summoners/na/Chawpsticks" target="_blank" rel="noreferrer"><span className="league bold">League of Legends</span></a>. Other than gaming, I do enjoy spending time hanging out with loved ones and travelling.</p>
              <div className="blob">
