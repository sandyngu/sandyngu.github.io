...
import Banff from '../../assets/images/photos/banff.jpg';
    ...
    <div className="welcome section" id="welcome">
        ...
        <div className="welcome__section">
            ...
            <div className="welcome__section-text">
                <img src={Funko} className="welcome__section-photo welcome__section-photo1" alt="Me"/>
                <img src={Banff} className="welcome__section-photo welcome__section-photo2" alt="Me"/>
